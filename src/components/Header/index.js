...
import { Button, Badge, Stack, HStack, Grid, Flex, Spacer, Text, Box } from "@chakra-ui/react"
    ...
    return(
        <div>
            {isAuthenticated ? (
                <>
                <Flex>
                <Text mt='4' fontSize='4xl'>ColorPixels</Text>
                <Spacer />
                <HStack>
                ...
                {/* <h1>Logged in as:</h1> */}
                <Badge colorScheme='green'>{truncateAddress(user.get("ethAddress"))}</Badge>
            ...
            <Box mt='4' mr='4'>
                ...
                dropContent={
                    <>
                    <Button p='4' mt='4' colorScheme='blue'
                onClick={() => {
